...
object AuthUtil {
    ...
    fun loadPrivateKey(): RSAPrivateCrtKey {
        val bytes: ByteArray = readAdbKey()
        val pemParser = PEMParser(InputStreamReader(ByteArrayInputStream(bytes)))
        val object1 = pemParser.readObject()
        val converter = JcaPEMKeyConverter().setProvider("BC")
        return converter.getPrivateKey(object1 as PrivateKeyInfo) as RSAPrivateCrtKey
    }
